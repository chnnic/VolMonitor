...
当前版本:`VolMon.sh` v1.4.9;`volmon-node.sh` v1.1.0。
...
每天定时推送一条汇总:各节点当日流量、连续失败次数、在线 / 离线统计;若节点设置了重置周期,还会显示距离重置日还有多少天。
...
————————————
🟢 香港家宽  今日 ↓3.73G ↑1.40G  失败 0次 · 距重置 12天
🔴 死机     今日 ↓0.00G ↑0.00G  失败 287次 · 距重置 12天
```
